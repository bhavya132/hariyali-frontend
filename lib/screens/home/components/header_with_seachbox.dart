...
class _HeaderWithSearchBoxState extends State<HeaderWithSearchBox> {
  ...
  Widget build(BuildContext context) {
    // print(actualuserinfo.DisplayPicture);
    return Container(
          ...
          Container(
            ...
            child: Row(
              children: <Widget>[
                ...
                Spacer(),
                CircleAvatar(
                  backgroundImage: Image.network(actualuserinfo.DisplayPicture).image,
                  // backgroundImage: Image.network("https://profile2019uce0056.blob.core.windows.net/imageanalysis/bhavyta_31eec36e-4adc-477c-929b-7b1dc746a1ee.jpg").image,
                  ...
                  Expanded(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: "Search about the plant",
                        hintStyle: TextStyle(
...
Future<void> GetSpeciesInformation(context, img64) async {
  SpeciesInfo actualSpeciesINfo = SpeciesInfo(isPlant: false, plantName: "",plantImg:"" ,wikiurl: "", Description: "" );
  String accessToken = "";
  if (Access_token == "") {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    accessToken = prefs.getString('access') ?? "";
